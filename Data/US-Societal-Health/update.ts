...
const V9_BREAKS: Record<string, string> = {
  ...
  brfssFrequentMentalDistress: "none known within 2019–2024 (the 2011 sampling redesign predates this series); CDC state median, not population-weighted",
...
const GSS_ITEMS_V9: { key: string; v: string; pos: number[]; valid: number[]; name: string; unit: string; dir: Meta["goodDirection"]; q: string }[] = [
  ...
  { key: "gssPeopleHelpful", v: "helpful", pos: [1], valid: [1, 2, 3], name: "People Try to Be Helpful", unit: "percent saying most people try to be helpful (vs. looking out for themselves)", dir: "up", q: "What people believe: Would you say that most of the time people try to be helpful, or that they are mostly just looking out for themselves?" },
  { key: "gssPeopleFair", v: "fair", pos: [2], valid: [1, 2, 3], name: "People Try to Be Fair", unit: "percent saying most people try to be fair (vs. would take advantage)", dir: "up", q: "What people believe: Do you think most people would try to take advantage of you if they got a chance, or would they try to be fair?" },
  { key: "gssLotOfAverageManWorse", v: "anomia5", pos: [1], valid: [1, 2], name: "Average Person's Lot Is Getting Worse", unit: "percent agreeing the lot of the average person is getting worse", dir: "down", q: "What people believe: In spite of what some people say, the lot (situation/condition) of the average man is getting worse, not better — do you agree or disagree?" },
