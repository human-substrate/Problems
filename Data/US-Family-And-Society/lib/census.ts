...
{key:"cohabitingCouples",file:"adults/uc1.xls",name:"Unmarried opposite-sex couples, direct measure",unit:"thousands of couples",markers:["UC-1.","Unmarried couples","POSSLQ"],column:"B",value:r=>n(r,"B"),note:"Direct relationship measure, 1996–2023. Before 2007 restricted to couples with a householder partner; all opposite-sex unmarried couples included from 2007. Paired with POSSLQ, never joined to it. The publisher file ends in 2023.",bounds:[0,20000]},
{key:"cohabitingCouplesPosslq",file:"adults/uc1.xls",name:"Opposite-sex adults sharing living quarters, POSSLQ",unit:"thousands of couples",markers:["UC-1.","POSSLQ"],column:"F",value:r=>n(r,"F"),note:"Indirect Partners of Opposite Sex Sharing Living Quarters classification; adults need not identify as unmarried partners. Decennial 1960/1970 and annual 1977–2006 observations, including three earlier annual observations present in the source beyond the requested 1980 start. Discontinued in 2007 when CPS measured cohabitation directly. Paired with cohabitingCouples, never joined; the direct measure's householder restriction changed in 2007.",bounds:[0,20000]},
];
