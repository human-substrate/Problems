...
> **2026-09-09:** New dataset **[US-Disease-And-Vaccination](Data/US-Disease-And-Vaccination/README.md)** — 35 series on infectious disease in the United States: reported incidence for 15 notifiable diseases back to 1950 (NCHS Health, United States table + CDC WONDER final annual counts), age-adjusted deaths from influenza and pneumonia (1900→) and HIV disease, COVID-19 deaths, and vaccination coverage and exemptions for children, kindergartners, adolescents, and adults 65+, with two eras of the same survey drawn as two series, never spliced. Research project `research/us-disease-vaccination-2026-09/` carries the filter, the year-mapping rule, and every candidate's disposition. Powers the new Disease & Vaccination section of **https://usstats.io**.
